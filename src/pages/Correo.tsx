        ...
        <div className="bg-white dark:bg-[#1e1a2e] rounded-2xl border border-slate-100 dark:border-slate-700/50 shadow-sm overflow-hidden flex flex-col">
          {selected ? (
            <>
              ...
              {/* Triage Bar - Moved here for maximum visibility */}
              <div className="px-5 py-3 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-700/50">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[10px] font-black text-primary uppercase tracking-widest">Triaje Inteligente con n8n</p>
                  {actioning && <span className="text-[10px] text-slate-400 animate-pulse font-bold">Procesando...</span>}
                </div>
                <div className="flex items-center gap-2">
                  <button
                    onClick={async () => {
                      ...
                      await dispararAutomatizacionManual('triage_auto', {
                        from: selected.from,
                      ...
                      setActioning(false);
                      alert('Enviado para Análisis Automático (IA)');
                    }}
                    disabled={actioning}
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-primary text-white text-[11px] font-bold rounded-xl shadow-sm hover:opacity-90 transition-all disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={actioning}
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-white dark:bg-slate-700 text-blue-600 dark:text-blue-400 text-[11px] font-bold rounded-xl border border-blue-100 dark:border-blue-900/30 hover:bg-blue-50 transition-all disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={actioning}
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-white dark:bg-slate-700 text-purple-600 dark:text-purple-400 text-[11px] font-bold rounded-xl border border-purple-100 dark:border-purple-900/30 hover:bg-purple-50 transition-all disabled:opacity-50"
                  >
